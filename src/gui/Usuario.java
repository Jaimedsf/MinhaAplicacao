 ...
 */
@Entity
@Table(name = "usuario", catalog = "projetojava", schema = "public")
@NamedQueries({
...
public class Usuario implements Serializable {
    ...
    public Usuario(Integer id, String nome, String email, String telefone, String endereco, String dataNascimento) {
        this.id = id;
        this.nome = nome;
        this.email = email;
